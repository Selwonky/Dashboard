...
export const workObjects: WorkObject[] = [
  ...
  { id: "obj_sales_north", priority: "low", area: "Pipeline", type: "prospect", typeLabel: "Prospect", department: "sales", title: "Northwind Logistics", statusLabel: "Researching", statusKind: "in_progress", owner: "Jo from Sales IC", preview: "Gathering signals before drafting outreach.", meta: [{ label: "Stage", value: "New" }] },
  ...
  { id: "obj_wf_onb", priority: "medium", type: "checklist", typeLabel: "Onboarding Checklist", department: "workforce", title: "New Contractor — Onboarding", statusLabel: "In progress", statusKind: "in_progress", owner: "Jo from Workforce IC", preview: "4 of 7 steps complete." },
